  ...
  return (
    <div style={{ backgroundColor: '#001f3f', color: 'white', fontFamily: 'Arial, sans-serif', height: '100vh', width: '100vw', padding: '10px', overflow: 'hidden' }}>
      ...
      <div className="d-flex justify-content-between align-items-center px-3"
        style={{ fontSize: '2.5rem', fontWeight: 'bold', color: '#7FDBFF', borderBottom: '2px solid #7FDBFF', paddingBottom: '4px', marginBottom: '8px' }}>
        <div style={{ width: '30%' }}>Projects</div>
        <div className="d-flex justify-content-around" style={{ width: '65%' }}>
          <span>Months</span>
          <span>Days</span>
          <span>Hours</span>
        </div>
        ...
        {displayedProjects.map((project) => {
          ...
          return (
            <div key={project._id} className="d-flex justify-content-between align-items-center"
              style={{
                backgroundColor: isOnHold ? '#ffcccc' : '#e6f7ff',
                color: isOnHold ? '#990000' : '#003366',
                borderRadius: '10px',
                padding: '10px 15px',
                fontSize: '2rem',
                minHeight: '90px',
              ...
              <div className="d-flex justify-content-around align-items-center" style={{ width: '65%' }}>
                {isOnHold ? (
                  <span style={{ fontWeight: 'bold', color: '#dc3545' }}>{project.status}</span>
                  ...
                  <span className="text-primary" style={{ fontWeight: 'bold' }}>Completed</span>
                )}
              </div>
            </div>
          );
